...
import DocumentLayout from "../templates/document/DocumentLayout";
import DocumentFooter from "../templates/document/DocumentFooter";
...
export default function DocumentPreview({
  ...
  return (
    ...
    >
        ...
        <div className="z-10 flex relative flex-col flex-grow p-10">
          <div className="absolute top-7 md:top-8 lg:top-10 right-10 z-20 flex items-center gap-2">
            ...
            <div className="bg-white p-1 border border-slate-200 rounded shadow-sm shrink-0">
              <QRCode value={verifyUrl} size={50} level="M" />
            </div>
          </div>

          <header
            id="page-header"
            className="flex justify-between items-start border-b-2 border-slate-900 pb-3 md:pb-2 mb-1 relative pr-44"
          >
            <div className="flex flex-col">
              ...
              <div className="relative ml-2 md:ml-2.75 lg:ml-3.5">
                ...
                <p className="ml-8 md:ml-11 lg:ml-15 text-[9px] md:text-xs lg:text-sm">
                  <strong> Build your Empire </strong>
                </p>
              </div>
            </div>
            <div className="absolute -bottom-[2px] left-0 w-30 md:w-40 lg:w-50 h-[2px] bg-gradient-to-r from-indigo-500 to-sky-400" />
          </header>
      ...
      <DocumentLayout pageNum={2} refProp={previewRefs[2]}>
        <div className="z-10 relative flex flex-col flex-grow p-10">
          <ContinuationHeader
