        ...
        <div className="bg-slate-50/50 border border-slate-100 rounded-lg p-3 shadow-sm relative">
          ...
          <div className="space-y-1 text-[12px]">
            <div className="grid grid-cols-3 gap-1">
              ...
              <span className="col-span-2 text-indigo-700 font-bold">{territory}</span>
            </div>
            <div className="grid grid-cols-3 gap-1">
            ...
            {partnerPassport && (
              <div className="grid grid-cols-3 gap-1">
                <span className="text-slate-400 font-medium">Passport / NID:</span>
            ...
            {partnerNationality && (
              <div className="grid grid-cols-3 gap-1">
                ...
                <span className="col-span-2 text-slate-800 font-semibold">{partnerNationality}</span>
              </div>
            )}
          </div>
        </div>
    ...
    >
        ...
        <div className="px-10 pt-8 pb-0 flex flex-col flex-1">
          ...
          {isCSP ? (
            <PartiesBlock
              ...
              partnerNationality={secondParty.nidNumber ? "" : ""}
      ...
      <DocumentLayout pageNum={2} refProp={previewRefs[1]}>
        <div className="px-10 pt-8 pb-0 flex flex-col flex-1">
          ...
          {/* ── Section 02 (CSP): Responsibilities — moved here to prevent page overflow ── */}
          {isCSP && (
      ...
      <DocumentLayout pageNum={3} refProp={previewRefs[2]}>
        <div className="px-10 pt-8 pb-0 flex flex-col flex-1">
          ...
          {/* ── Section 07 (CSP: Term & Termination | SAG: Confidentiality) ── */}
          {isCSP ? (
          ...
          {/* ── Section 08 (CSP: Code of Conduct | SAG: Governing Law) ── */}
          {isCSP ? (
        ...
        <DocumentLayout pageNum={5} refProp={previewRefs[4]}>
          <div className="px-10 pt-8 pb-0 flex flex-col flex-1">
            ...
            <Section num="09" title="Governing Law (Continued)">
              <p className="font-semibold text-slate-800 mb-1">9.8 Compliance with Applicable Laws</p>
              <p>
