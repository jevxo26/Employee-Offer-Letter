...
export default function InternshipDocumentPreview({
  ...
  return (
    <div id="internship-preview-container" className="flex flex-col select-text" style={{ width: A4_WIDTH }}>
      {/* Single A4 page */}
      <div
      ...
      >
        ...
        <div className="z-10 flex flex-col flex-grow px-10 pt-8 pb-4 gap-3">
          ...
          <header className="flex justify-between items-start border-b-2 border-slate-900 pb-3 mb-1">
            ...
            <div className="text-right font-sans">
              ...
              <span className="text-[11px] text-slate-600 font-bold">Intern ID: {d.internId}</span>
            </div>
          </header>

          {/* Date + addressee */}
          <p className="text-[13px] text-slate-600 font-sans italic">Date: <strong className="text-slate-800 not-italic font-semibold">{d.date}</strong></p>
          <p className="text-[14px] font-bold text-slate-900 font-sans">{d.internName}</p>

          {/* Subject line */}
          <p className="text-[13px] text-slate-700 font-sans">
            Subject: <strong className="text-slate-900">Internship Offer for {d.position}</strong>
          </p>
          ...
          <p className="text-[13px] text-slate-600 leading-relaxed text-justify font-sans">
            We are thrilled to offer you the opportunity to join <strong>{d.companyName}</strong> as a{" "}
            <strong>{d.position}</strong> Intern. This letter serves as a formal agreement detailing the
            terms and conditions of your internship. We believe that your skills and enthusiasm will add
            significant value to our team and look forward to an exciting journey together.
          </p>

          {/* Internship Details */}
          <div>
            <h4 className="font-bold text-[14px] text-slate-900 font-sans mb-1.5">Internship Details</h4>
            <ol className="list-decimal ml-5 space-y-1 text-[13px] text-slate-700 leading-relaxed font-sans">
              <li>
                <strong>Duration:</strong> Your internship will span <strong>{d.duration}</strong>, starting
                from your official joining date, which will be the day you receive your email credentials.
              </li>
              <li>
              ...
              <li>
                <strong>Privileges:</strong> As an intern, you will enjoy nearly all the rights and
                privileges of our employees, ensuring a sense of inclusion and providing you with a
          ...
          {/* Responsibilities */}
          <div>
            <h4 className="font-bold text-[14px] text-slate-900 font-sans mb-1.5">Your Responsibilities</h4>
            <ol className="list-decimal ml-5 space-y-1 text-[13px] text-slate-700 leading-relaxed font-sans">
              <li>Adhere to the rules and regulations of {d.companyName} at all times.</li>
              <li>Follow the guidance and instructions provided by your mentors and senior officers.</li>
              <li>Complete and submit all assigned tasks within the stipulated deadlines.</li>
            </ol>
          </div>

          {/* Termination Policy */}
          <div>
            <h4 className="font-bold text-[14px] text-slate-900 font-sans mb-1">Termination Policy</h4>
            <p className="text-[13px] text-slate-700 leading-relaxed font-sans">
              Your internship may be revoked under the following circumstances: participation in activities
              that violate the law or company policies; engaging in conduct that harms the company&apos;s
          ...
          {/* Acceptance of Terms */}
          <div>
            <h4 className="font-bold text-[14px] text-slate-900 font-sans mb-1">Acceptance of Terms</h4>
            <p className="text-[13px] text-slate-700 leading-relaxed text-justify font-sans">
              By signing below, you agree to the terms outlined in this offer. Please confirm your
              acceptance by signing and returning a scanned copy of this letter to{" "}
              <strong>{d.companyEmail}</strong>. We are excited to welcome you to the{" "}
              {d.companyName} family and look forward to crafting an extraordinary future together.
            </p>
          </div>

          {/* Founder sign-off */}
          <div className="mt-1">
            <p className="text-[13px] text-slate-600 font-sans mb-4">Warm regards,</p>
            ...
            <p className="text-[13px] font-bold text-slate-900 font-sans">{d.founderName}</p>
            <p className="text-[12px] text-slate-600 font-sans">{d.founderRole}, {d.companyName}</p>
          </div>

          {/* Acknowledgment */}
          <div className="border-t border-slate-200 pt-3 mt-1">
            <p className="text-[13px] font-bold text-slate-900 font-sans mb-1">Acknowledgment and Acceptance</p>
            <p className="text-[13px] text-slate-600 font-sans mb-3">
              I have read, understood, and agreed to the terms and conditions of this internship offer.
            </p>
            <div className="flex gap-12 text-[13px] font-sans">
              <div>
        ...
        {/* Footer */}
        <footer className="z-10 px-10 pb-6 pt-1 border-t border-slate-200 text-[12px] text-slate-400 font-mono flex justify-between items-center">
          <div className="flex gap-3">
            <span>Email: <strong className="text-slate-600 font-semibold">{d.companyEmail}</strong></span>
            <span>|</span>
            <span>Web: <strong className="text-slate-600 font-semibold">{firstParty.website || "www.jevxo.com"}</strong></span>
          </div>
